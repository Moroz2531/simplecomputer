...
int main(int argv, char *argc[]) {
  ...
  bc_box(85, 1, 24, 2, DEFAULT, FG_WHITE, " Регистр флагов ", BG_RED, DEFAULT);
  bc_box(62, 4, 22, 2, DEFAULT, FG_WHITE, " Счетчик команд ", BG_RED, DEFAULT);
  bc_box(85, 4, 24, 2, DEFAULT, FG_WHITE, " Команда ", BG_RED, DEFAULT);
  bc_box(62, 7, 47, 11, DEFAULT, FG_WHITE, " Редактируемая ячейка (увеличено) ",
         BG_RED, FG_WHITE);
